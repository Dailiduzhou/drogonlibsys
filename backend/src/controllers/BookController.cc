...
void BookController::list(const drogon::HttpRequestPtr &req,
    ...
    for (const auto &b : books) data.append(bookJson(b));
    cb(ApiResponse::ok(data));
}

void BookController::get(const drogon::HttpRequestPtr &req,
                         std::function<void(const drogon::HttpResponsePtr &)> &&cb,
                         int64_t id) {
    BookService svc;
...
void BookController::create(const drogon::HttpRequestPtr &req,
                            std::function<void(const drogon::HttpResponsePtr &)> &&cb) {
...
void BookController::update(const drogon::HttpRequestPtr &req,
                            std::function<void(const drogon::HttpResponsePtr &)> &&cb,
                            int64_t id) {
    auto json = req->getJsonObject();
    if (!json) {
...
void BookController::remove(const drogon::HttpRequestPtr &req,
                            std::function<void(const drogon::HttpResponsePtr &)> &&cb,
                            int64_t id) {
    BookService svc;
...
void BookController::uploadCover(const drogon::HttpRequestPtr &req,
                                 std::function<void(const drogon::HttpResponsePtr &)> &&cb,
                                 int64_t id) {
